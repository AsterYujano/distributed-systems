...
try:
    ...
    # BOARD FUNCTIONS
    # ------------------------------------------------------------------------------------------------------
    # What's the propose of the variable is_propagated_call in all this functions?
    ...
    def contact_vessel(vessel_ip, path, payload=None, req='POST'):
        ...
        try:
            ...
            # why are we using parenthesis here for printing?
            print(res.text)
    ...
    def client_add_received():
        ...
        # what's the utility of node_id? 
        # Should I "recall" node_id here in order to use that variable in the function propagate_to_vessels?
        global board, node_id
        try:
        	# what's the difference between request.form and requests?
    ...
    def propagation_received(action, element_id):
        global board
	    # if action == delete payload is not needed
